...
namespace achihapi.Models
{
    public partial class achihdbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TFinOrder>(entity =>
            {
                entity.ToTable("t_fin_order");
                ...
                entity.HasOne(d => d.H)
                    .WithMany(p => p.TFinOrder)
                    .HasForeignKey(d => d.Hid)
                    .HasConstraintName("FK_t_fin_order_HID");
            });

            modelBuilder.Entity<TFinOrderSrule>(entity =>
            {
                entity.HasKey(e => new { e.Ordid, e.Ruleid });

                entity.ToTable("t_fin_order_srule");
