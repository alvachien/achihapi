...
namespace hihapi.test.UnitTests
{
    ...
    public class FinanceReportByOrdersControllerTest : IDisposable
    {
        ...
        public FinanceReportByOrdersControllerTest(SqliteDatabaseFixture fixture)
        {
        ...
        public void TestController1(int hid, string user)
        {
            ...
            // 2. Test it
            var controller = new FinanceReportByOrdersController(context);
            ...
            var expamt = context.FinanceOrder.Where(p => p.HomeID == hid).Count();
