...
namespace hihapi.unittest.Learn
{
    ...
    public class LearnObjectsControllerTest
    {
        ...
        public async Task TestCase_CRUD(int hid, string usr)
        {
            ...
            var getallokresultval = Assert.IsAssignableFrom<IQueryable<LearnObject>>(getallokresult.Value);

            //if (getallokresultval.Count() > 0)
            //{
            //    // Read first one.
            //    var getsingleresult = control.Get(getallokresultval.First().ID);
            //}
